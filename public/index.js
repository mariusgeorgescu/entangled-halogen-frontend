...
var applyFirst = function(dictApply) {
  ...
  return function(a3) {
    return function(b2) {
      return apply1(map38($$const)(a3))(b2);
    };
  };
};
var applySecond = function(dictApply) {
  ...
  return function(a3) {
    return function(b2) {
      return apply1(map38($$const(identity2))(a3))(b2);
    };
  };
};
    ...
    return {
      show: function(v2) {
        if (v2 instanceof Left) {
          return "(Left " + (show10(v2.value0) + ")");
        }
        ;
        if (v2 instanceof Right) {
          return "(Right " + (show16(v2.value0) + ")");
        }
        ;
...
var $$try = function(dictMonadError) {
  ...
  return function(a3) {
    return catchError1(map38(Right.create)(a3))(function($52) {
...
var asks = function(dictMonadAsk) {
  var map38 = map(dictMonadAsk.Monad0().Bind1().Apply0().Functor0());
            ...
            function go2(bot, top3) {
              switch (top3 - bot) {
                ...
                default:
                  ...
                  return apply4(map38(concat2)(go2(bot, pivot)))(go2(pivot, top3));
              }
            }
...
var traversableMaybe = {
  traverse: function(dictApplicative) {
    ...
    return function(v2) {
      return function(v1) {
        ...
        ;
        if (v1 instanceof Just) {
          return map38(Just.create)(v2(v1.value0));
        }
        ;
  ...
  sequence: function(dictApplicative) {
    ...
    return function(v2) {
      ...
      ;
      if (v2 instanceof Just) {
        return map38(Just.create)(v2.value0);
      }
      ;
...
var some = function(dictAlternative) {
  ...
  var map38 = map(dictAlternative.Plus1().Alt0().Functor0());
  return function(dictLazy) {
    var defer4 = defer(dictLazy);
    return function(v2) {
      return apply1(map38(cons)(v2))(defer4(function(v1) {
...
var many = function(dictAlternative) {
  ...
  return function(dictLazy) {
    return function(v2) {
      return alt9(some(dictAlternative)(dictLazy)(v2))(pure110([]));
    };
  };
};
...
var filterA = function(dictApplicative) {
  ...
  var map38 = map(dictApplicative.Apply0().Functor0());
  return function(p2) {
    var $191 = map38(mapMaybe(function(v2) {
      if (v2.value1) {
    ...
    var $192 = traverse12(function(x) {
      return map38(Tuple.create(x))(p2(x));
    });
    return function($193) {
      return $191($192($193));
    };
...
var foldM = function(dictMonad) {
  ...
  return function(f) {
    return function(z2) {
      return _foldM(bind17)(f)(pure110(z2));
    };
  };
};
...
var ffiUtil = /* @__PURE__ */ (function() {
  var unsafeFromRight2 = function(v2) {
    if (v2 instanceof Right) {
      return v2.value0;
    }
    ;
  ...
  return function(req) {
    ...
    var extractContent = function(v3) {
      ...
      if (v3 instanceof FormURLEncoded) {
        return note("Body contains values that cannot be encoded as application/x-www-form-urlencoded")(map7(unsafeToForeign)(encode(v3.value0)));
      }
      ;
...
var coerce3 = function(fn) {
  ...
  })(identity8)(runExcept(alt3(unsafeReadTagged3("Error")(fn))(map8(error)(readString2(fn)))));
};
...
var getUtxos = function(api) {
  return function(mAmount) {
    return function(mPaginate) {
      ...
      return map9(toMaybe)(toAffE(_getUtxos(api)(amount)(paginate)));
    };
  };
};
...
var getCollateral = function(api) {
  return function(amount) {
    return map9(toMaybe)(toAffE(_getCollateral(api)(amount)));
  };
};
...
var snoc4 = function(cat) {
  return function(a3) {
    return append3(cat)(new CatCons(a3, empty3));
  };
};
...
var substFree = function(k) {
  var go2 = function(f) {
    ...
    if (v2 instanceof Bind) {
      return bind3(k(v2.value0))(map10(go2)(v2.value1));
    }
    ;
...
var foldFree = function(dictMonadRec) {
  ...
  return function(k) {
    var go2 = function(f) {
      var v2 = toView(f);
      if (v2 instanceof Return) {
        return map116(Done.create)(pure110(v2.value0));
      }
      ;
      if (v2 instanceof Bind) {
...
var getTheAvailableWallets = function(dictMonadCIP30) {
  ...
  return bind17(getAvailableWallets2(dictMonadCIP30))(function(ws) {
    return bind17(sequence12(map13(getIcon1)(ws)))(function(is) {
...
var unsafeFromRight = /* @__PURE__ */ either(function(v2) {
...
var gEncodeJsonCons1 = /* @__PURE__ */ gEncodeJsonCons(/* @__PURE__ */ encodeJsonArray(encodeJsonJString));
...
var gEncodeJsonCons22 = /* @__PURE__ */ gEncodeJsonCons2(gEncodeJsonNil);
var userAddressesIsSymbol = {
  reflectSymbol: function() {
    return "userAddresses";
  }
  ...
  return function(dictMonadCIP30) {
    ...
    return function(api) {
      return function(unsignedTxCbor) {
        return bind17(signTx3(api)(unsignedTxCbor)(true))(function(signedTx) {
...
var getDecodedJson = /* @__PURE__ */ either(function($325) {
  return $$throw(printJsonDecodeError($325));
...
var encodeJsonUserAddresses = {
  encodeJson: /* @__PURE__ */ genericEncodeAeson(genericUserAddresses)(/* @__PURE__ */ encodeAesonConstructor(/* @__PURE__ */ encodeRepAesonArgsArgument(/* @__PURE__ */ encodeRecord(/* @__PURE__ */ gEncodeJsonCons2(/* @__PURE__ */ gEncodeJsonCons1(/* @__PURE__ */ gEncodeJsonCons1(gEncodeJsonNil)(usedAddressesIsSymbol)())(stakeAddressesIsSymbol)())(changeAddressIsSymbol)())()))(UserAddressesIsSymbol)(areAllConstructorsNullary_Constructor2)(isSingleConstructor_Constructor))(defaultOptions)
};
var gEncodeJsonCons3 = /* @__PURE__ */ gEncodeJsonCons(/* @__PURE__ */ encodeJsonMaybe(encodeJsonJString))(/* @__PURE__ */ gEncodeJsonCons(encodeJsonUserAddresses)(gEncodeJsonNil)(userAddressesIsSymbol)())(recipientIsSymbol)();
var encodeJsonInteraction = function(dictEncodeJson) {
  return {
    encodeJson: genericEncodeAeson2(encodeAesonConstructor(encodeRepAesonArgsArgument(encodeRecord(gEncodeJsonCons(dictEncodeJson)(gEncodeJsonCons3)(actionIsSymbol)())()))(InteractionIsSymbol)(areAllConstructorsNullary_Constructor2)(isSingleConstructor_Constructor))(defaultOptions)
  };
};
var encodeJsonAddWitAndSubmitParams = {
  encodeJson: /* @__PURE__ */ genericEncodeAeson(genericAddWitAndSubmitParams)(/* @__PURE__ */ encodeAesonConstructor(/* @__PURE__ */ encodeRepAesonArgsArgument(/* @__PURE__ */ encodeRecord(/* @__PURE__ */ gEncodeJsonCons2(/* @__PURE__ */ gEncodeJsonCons22(tx_witIsSymbol)())(tx_unsignedIsSymbol)())()))(AddWitAndSubmitParamsIsSymbol)(areAllConstructorsNullary_Constructor2)(isSingleConstructor_Constructor))(defaultOptions)
};
    ...
    return function(serverEnv) {
      return function(unsignedTxCbor) {
        return function(signedTx) {
          var env = unwrap4(serverEnv);
          var req = {
            url: env.submitTxURL,
            method: new Left(POST.value),
            responseFormat: json,
            headers: [new RequestHeader("Authorization", "Basic " + encode3(env.basicUser + (":" + env.basicPassword)))],
            content: new Just(new Json(encodeJson2({
              tx_unsigned: unsignedTxCbor,
              tx_wit: signedTx
            }))),
            password: new Just(env.basicPassword),
            username: new Just(env.basicUser),
            timeout: new Just(1e7),
            withCredentials: true
          };
          return bind17(liftAff3(request2(req)))(function(result) {
            if (result instanceof Right) {
              return bind17(liftEffect11(getDecodedJson(decodeJson2((function(v2) {
                return v2.body;
            ...
            ;
            throw new Error("Failed pattern match at Capabilities.MonadInteraction (line 244, column 5 - line 248, column 47): " + [result.constructor.name]);
          });
        };
      };
    };
...
var defaultServerEnv = {
  buildTxURL: "http://localhost:8082/build-tx",
  submitTxURL: "http://localhost:8082/submit-tx",
  basicUser: "cardano",
  basicPassword: "lovelace",
  allowedNetwork: "Preprod"
};
        ...
        return function(serverEnv) {
          return function(interaction) {
            ...
            return bind17(liftAff3(request2(req)))(function(result) {
              ...
              ;
              throw new Error("Failed pattern match at Capabilities.MonadInteraction (line 215, column 3 - line 219, column 44): " + [result.constructor.name]);
            });
          };
        };
      };
      ...
      return function(dictDecodeJsonField) {
        ...
        return function(dictMonadCIP30) {
          ...
          return function(serverEnv) {
            return function(api) {
              return function(a3) {
                return bind17(getUsedAddresses3(api)(Nothing.value))(function(usedAddresses) {
                  return bind17(getChangeAddress3(api))(function(changeAddress) {
                    return bind17(getRewardAddresses3(api))(function(stakeAddresses) {
                      var interaction = {
                        action: a3,
                      ...
                      return discard13(liftEffect11(consoleLog(show3(toJsonString2(interaction)))))(function() {
  ...
  return function(dictEncodeJson) {
    ...
    return function(dictDecodeJson) {
      ...
      return function(dictDecodeJsonField) {
        ...
        return function(dictMonadCIP30) {
          return {
            buildTransaction: buildTransactionDefault4(dictMonadCIP30),
            submitTransaction: submitTransactionDefault1(dictMonadCIP30),
...
var defaultEnv = defaultServerEnv;
...
var runGraft = /* @__PURE__ */ unGraft(function(v2) {
  var go2 = function(v22) {
    ...
    if (v22 instanceof Elem) {
      return new Elem(v22.value0, v22.value1, v2.value0(v22.value2), map17(go2)(v22.value3));
    }
    ;
    if (v22 instanceof Keyed) {
      return new Keyed(v22.value0, v22.value1, v2.value0(v22.value2), map17(map18(go2))(v22.value3));
    }
    ;
  ...
  map: function(v2) {
    return function(v1) {
      if (v1 instanceof Handler) {
        return new Handler(v1.value0, map20(map110(v2))(v1.value1));
      }
      ;
      if (v1 instanceof Ref) {
        return new Ref(map20(map110(v2))(v1.value0));
      }
      ;
      return v1;
    };
...
var bifunctorHTML = {
  bimap: function(f) {
    return function(g) {
      return function(v2) {
        return bimap3(map21(map111(map22(g))))(f)(v2);
      };
    };
  }
};
  ...
  return function(v2) {
    ...
    if (v2 instanceof Query) {
      return unCoyoneda(function(g) {
        var $45 = map23(maybe(v2.value1(unit))(g));
        return function($46) {
...
var runParserT = function(dictMonadRec) {
  ...
  return function(s2) {
    return function(p2) {
      ...
      return map38(fst)(runParserT$prime1(initialState5)(p2));
    };
  };
};
...
var option = function(a3) {
  return function(p2) {
    return alt4(p2)(pure6(a3));
  };
};
var optionMaybe = function(p2) {
  return option(Nothing.value)(map25(Just.create)(p2));
};
...
var runP = function(p2) {
  return function(s2) {
    return lmap3(printError2)(runParser(s2)(applyFirst2(p2)(eof)));
  };
};
...
var formatParser = /* @__PURE__ */ bind5(/* @__PURE__ */ optionMaybe(/* @__PURE__ */ $$try4(/* @__PURE__ */ string("+"))))(function(sign2) {
  return bind5(some3(string("0")))(function(before) {
    return bind5(optionMaybe($$try4(string(",0"))))(function(comma) {
      return bind5(optionMaybe($$try4(string("."))))(function(dot) {
        return bind5($$for2(dot)(function(v2) {
          return $$try4(many2(string("0")));
        }))(function(after) {
          return bind5(optionMaybe($$try4(string("a"))))(function(abbreviations) {
            return pure7({
              sign: isJust(sign2),
              before: length(before),
              comma: isJust(comma),
              after: fromMaybe(0)(map112(length)(after)),
...
var printColor = function(v2) {
  if (v2 instanceof RGB) {
    return "rgb(" + (show6(v2.value0) + ("," + (show6(v2.value1) + ("," + (show6(v2.value2) + ")")))));
  }
  ;
  if (v2 instanceof RGBA) {
    return "rgba(" + (show6(v2.value0) + ("," + (show6(v2.value1) + ("," + (show6(v2.value2) + ("," + (show15(v2.value3) + ")")))))));
  }
  ;
...
var viewBox = function(x_) {
  return function(y_) {
    return function(w) {
      return function(h_) {
        return attr2("viewBox")(joinWith(" ")(map27(show7)([x_, y_, w, h_])));
      };
    };
  };
};
...
var renderToasts = function(toasts) {
  return div3([classes(["toast toast-center toast-top z-[9999]"])])(map28(renderToast)(toasts));
};
var renderTextRotate = function(classes2) {
  return function(texts) {
    return span4([classes(["text-rotate " + classes2])])([span4([classes(["justify-items-center"])])(map28(function(t2) {
...
var render = function(s2) {
  var printConnectedWallet = (function() {
    ...
    ;
    throw new Error("Failed pattern match at Components.WalletConnectComponent (line 180, column 26 - line 192, column 8): " + [s2.connectedWalletInfo.constructor.name]);
  })();
  ...
  var renderWalletWidgetDetails = function(v2) {
    ...
    if (v2.connectedWalletInfo instanceof Nothing) {
      var $49 = $$null(v2.availableWalletExtensions);
      if ($49) {
      ...
      ;
      return ul([tabIndex2(0), classes(["dropdown-content menu  bg-" + (buttonColour + ("  text-" + (buttonColour + "-content rounded-box z-40 w-64 p-2 ")))])])(map29(renderWalletListItem)(v2.availableWalletExtensions));
    }
    ;
    throw new Error("Failed pattern match at Components.WalletConnectComponent (line 194, column 97 - line 246, column 63): " + [v2.connectedWalletInfo.constructor.name]);
  };
    ...
    return function(v2) {
      if (v2 instanceof SetWalletApi) {
        return bind6(getTheAvailableWallets2)(function(ws) {
          return discard3(modify_3(function(v1) {
            ...
            return pure9(new Just(v2.value1));
          });
        });
      }
      ;
      if (v2 instanceof GetWalletApi) {
        return bind6(gets2(function(v1) {
          ...
          return pure9(new Just(v2.value0(api)));
        });
      }
      ;
      if (v2 instanceof GetConnectedWalletInfo) {
        return bind6(gets2(function(v1) {
          ...
          return pure9(new Just(v2.value0(wi)));
        });
      }
      ;
      if (v2 instanceof GetAvailableWalletExtensions) {
        return bind6(gets2(function(v1) {
          ...
          return pure9(new Just(v2.value0(ws)));
        });
      }
      ;
      throw new Error("Failed pattern match at Components.WalletConnectComponent (line 115, column 15 - line 128, column 23): " + [v2.constructor.name]);
    };
  };
};
var handleAction = function(dictMonadAff) {
  ...
  return function(dictMonadCIP30) {
    return function(v2) {
      if (v2 instanceof ConnectWallet) {
        return bind6(enableWallet2(v2.value0))(function(api) {
          return bind6(getNetworkName2(api))(function(network) {
            return bind6(getName3(v2.value0))(function(name17) {
      ...
      ;
      throw new Error("Failed pattern match at Components.WalletConnectComponent (line 135, column 16 - line 161, column 36): " + [v2.constructor.name]);
    };
  };
};
...
var map31 = /* @__PURE__ */ map(functorEmitter);
var innerIsSymbol = {
  reflectSymbol: function() {
    return "inner";
  }
  ...
  return function(selector) {
    return function(action2) {
      return bind7(emitSelected2(selector))(function(emitter) {
        return $$void5(subscribe2(map31(action2)(emitter)));
      });
    };
  };
};
        ...
        var handleAction5 = function(v1) {
          if (v1 instanceof Initialize2) {
            return discard4(subscribe1(v2)(Update2.create))(function() {
              return bind7(map113(v2.select)(getStore2))(function(context) {
...
var render2 = function(dictMonadAff) {
  ...
  return function(dictMonadCIP30) {
    ...
    return function(state3) {
      ...
      })])([img([src9("./images/E7D/SVG Vector Files/Transparent Logo.svg"), alt8("E7D Logo"), classes(["h-20"])])])]), div3([classes(["flex-2 flex justify-end"])])([slot3(walletConnectProxy)(unit)(component22)({
          ...
          return function(v2) {
            ...
            if (v2 instanceof HandleWalletConnectOutput) {
              if (v2.value0 instanceof WalletConnectedEvent) {
                return bind8(query3(walletConnectProxy)(unit)(new GetWalletApi(identity14)))(function(mApi) {
              ...
              if (v2.value0 instanceof CustomButtonEvent) {
                return discard5(liftEffect11(consoleLog(show8(v2.value0.value0))))(function() {
                  ...
                  if (elem3(v2.value0.value0)(["DelegateToPool", "DelegateToDRep", "DelegateToPoolAndDRep"])) {
                    return bind8(gets4(function(v1) {
                      ...
                      ;
                      throw new Error("Failed pattern match at Components.NavBar (line 139, column 13 - line 143, column 35): " + [walletApi.constructor.name]);
                    });
                  }
                  ;
                  return liftEffect11(consoleLog(show8("Unknown button event")));
                });
              }
              ;
              throw new Error("Failed pattern match at Components.NavBar (line 121, column 36 - line 144, column 69): " + [v2.value0.constructor.name]);
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at Components.NavBar (line 114, column 16 - line 145, column 34): " + [v2.constructor.name]);
          };
        };
      };
    };
    ...
    return function(dictMonadCIP30) {
      return function(dictMonadStore) {
        return function(s2) {
          ...
          ;
          throw new Error("Failed pattern match at Components.Home (line 238, column 23 - line 246, column 45): " + [s2.currentPage.constructor.name]);
        };
      };
    };
  };
  ...
  return function(dictMonadCIP30) {
    return function(dictMonadStore) {
      return function(dictMonadAsk) {
        ...
        return function(s2) {
          return div_([renderWalletWidgetSlot2, renderBodyContent2(s2), renderFooterSection, renderFabFlower, renderToasts(map32(getToast)(s2.toasts))]);
        };
      };
    };
  };
...
var handleAction4 = function(dictMonadAff) {
  ...
  var interactionMonadDefault2 = interactionMonadDefault(monadAffHalogenM2)(encodeJsonJString)(decodeJsonString)(decodeFieldId3)(monadCip30HalogenM(dictMonadAff));
  var signTransaction2 = signTransaction(interactionMonadDefault2);
  var submitTransaction2 = submitTransaction(interactionMonadDefault2);
  var buildTransaction2 = buildTransaction(interactionMonadDefault2);
  return function(dictMonadCIP30) {
    return function(dictMonadStore) {
      return function(dictMonadAsk) {
          ...
          return function(action2) {
            if (action2 instanceof Initialize5) {
              var createTimerEmitter = function(dictMonadAff1) {
                ...
                var pure110 = pure(Monad0.Applicative0());
                return function(val) {
                  return bind17(liftEffect22(create))(function(v2) {
                    return bind17(liftAff3(forkAff(forever2(discard1(delay(1e3))(function() {
                      return liftEffect6(notify(v2.listener)(val));
                    })))))(function() {
                      return pure110(v2.emitter);
                    });
                  });
                };
              };
            ...
            if (action2 instanceof Tick) {
              return bind9(map114(function($195) {
                return unwrap7(unInstant($195));
            ...
            if (action2 instanceof SignTransaction) {
              return bind9(signTransaction2(action2.value0)(action2.value1))(function(signedTxResult) {
                return discard22((function() {
                  if (signedTxResult instanceof Right) {
                    return discard22(modify_6(function(s2) {
                      var $133 = {};
                      for (var $134 in s2) {
                        if ({}.hasOwnProperty.call(s2, $134)) {
                          $133[$134] = s2[$134];
                        }
                        ;
                      }
                      ;
                      $133.toasts = cons(txSubmitSuccessToast)(s2.toasts);
                      return $133;
                    }))(function() {
                  ...
                  if (signedTxResult instanceof Left) {
                    return modify_6(function(s2) {
                      ...
                      ;
                      $137.toasts = cons(txSubmitFailedToast(signedTxResult.value0))(s2.toasts);
                      return $137;
                    });
                  }
                  ;
                  throw new Error("Failed pattern match at Components.Home (line 143, column 5 - line 148, column 79): " + [signedTxResult.constructor.name]);
                })())(function() {
                  return pure14(unit);
                });
              });
            ...
            if (action2 instanceof SubmitTransaction) {
              return bind9(submitTransaction2(defaultServerEnv)(action2.value0)(action2.value1))(function(submitResult) {
                return discard22((function() {
                  if (submitResult instanceof Right) {
                    return modify_6(function(s2) {
                      var $144 = {};
                      for (var $145 in s2) {
                        if ({}.hasOwnProperty.call(s2, $145)) {
                          $144[$145] = s2[$145];
                        }
                        ;
                      }
                      ;
                      $144.toasts = cons(txConfirmedSuccessToast(submitResult.value0))(s2.toasts);
                      return $144;
                    });
                  }
                  ;
                  if (submitResult instanceof Left) {
                    return modify_6(function(s2) {
                      ...
                      ;
                      $148.toasts = cons(txConfirmedFailedToast(submitResult.value0))(s2.toasts);
                      return $148;
                    });
                  }
                  ;
                  throw new Error("Failed pattern match at Components.Home (line 152, column 5 - line 156, column 82): " + [submitResult.constructor.name]);
                })())(function() {
            ...
            if (action2 instanceof HandleNavBarOutput) {
              ...
              if (action2.value0 instanceof BuildTransactionEvent) {
                return bind9(buildTransaction2(defaultServerEnv)(action2.value0.value1)(action2.value0.value0))(function(buildResult) {
                  return discard22(liftEffect12(consoleLog(show9(buildResult))))(function() {
                    return discard22((function() {
                      if (buildResult instanceof Right) {
                        return discard22(modify_6(function(s2) {
                          var $156 = {};
                          for (var $157 in s2) {
                            if ({}.hasOwnProperty.call(s2, $157)) {
                              $156[$157] = s2[$157];
                            }
                            ;
                          }
                          ;
                          $156.toasts = cons(txBuildSuccessToast)(s2.toasts);
                          return $156;
                        }))(function() {
                      ...
                      if (buildResult instanceof Left) {
                        return modify_6(function(s2) {
                          ...
                          ;
                          $160.toasts = cons(txBuildFailedToast(buildResult.value0))(s2.toasts);
                          return $160;
                        });
                      }
                      ;
                      throw new Error("Failed pattern match at Components.Home (line 165, column 7 - line 170, column 80): " + [buildResult.constructor.name]);
                    })())(function() {
                      return pure14(unit);
                    });
                  });
              ...
              if (action2.value0 instanceof InvalidNetworkEvent) {
                return bind9(asks2(function($196) {
                  return (function(v2) {
                    return v2.allowedNetwork;
                  })(unwrap7($196));
                  ...
                  return modify_6(function(s2) {
                    ...
                    ;
                    $166.toasts = cons(newToast)(s2.toasts);
                    return $166;
                  });
                });
              }
              ;
              throw new Error("Failed pattern match at Components.Home (line 159, column 35 - line 177, column 62): " + [action2.value0.constructor.name]);
            }
            ;
            if (action2 instanceof StartEarningRewardsButton) {
              return bind9(query4(navbarProxy)(unit)(new GetWalletApi2(identity15)))(function(mApi) {
                ...
                return modify_6(function(s2) {
                  var $173 = {};
                  for (var $174 in s2) {
                    if ({}.hasOwnProperty.call(s2, $174)) {
                      $173[$174] = s2[$174];
                    }
                    ;
                  }
                  ;
                  $173.toasts = cons(walletNotConnectedToast)(s2.toasts);
                  return $173;
                });
              });
            }
            ...
            if (action2 instanceof LetUsBeYourDRepButton) {
              return bind9(query4(navbarProxy)(unit)(new GetWalletApi2(identity15)))(function(mApi) {
                ...
                return modify_6(function(s2) {
                  ...
                  ;
                  $179.toasts = cons(walletNotConnectedToast)(s2.toasts);
                  return $179;
                });
              });
            }
            ...
            if (action2 instanceof BothButton) {
              return bind9(query4(navbarProxy)(unit)(new GetWalletApi2(identity15)))(function(mApi) {
                ...
                return modify_6(function(s2) {
                  var $185 = {};
                  for (var $186 in s2) {
                    if ({}.hasOwnProperty.call(s2, $186)) {
                      $185[$186] = s2[$186];
                    }
                    ;
                  }
                  ;
                  $185.toasts = cons(walletNotConnectedToast)(s2.toasts);
                  return $185;
                });
              });
            }
            ...
            if (action2 instanceof ChangePage) {
              return discard22(liftEffect12(scrollToTop))(function() {
                return modify_6(function(v2) {
                  ...
                  ;
                  $188.currentPage = action2.value0;
                  return $188;
                });
              });
            }
            ...
            ;
            throw new Error("Failed pattern match at Components.Home (line 120, column 23 - line 200, column 67): " + [action2.constructor.name]);
          };
        };
      };
    };
...
var awaitBody = /* @__PURE__ */ discard7(bindAff)(awaitLoad)(function() {
  return bind10(selectElement("body"))(function(body2) {
    return maybe(throwError3(error("Could not find body")))(pure15)(body2);
  });
});
...
var queueOrRun = function(ref2) {
  return function(au) {
    return bind13(liftEffect8(read(ref2)))(function(v2) {
      if (v2 instanceof Nothing) {
        return au;
      }
      ;
...
var handleLifecycle = function(lchs) {
  return function(f) {
    return discard12(liftEffect8(write({
      ...
      return bind13(liftEffect8(f))(function(result) {
        return bind13(liftEffect8(read(lchs)))(function(v2) {
...
var evalQ = function(render5) {
  return function(ref2) {
    return function(q3) {
      return bind13(liftEffect8(read(ref2)))(function(v2) {
        return evalM(render5)(ref2)(v2["component"]["eval"](new Query(map34(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
      });
    };
  };
};
  ...
  return function(initRef) {
    return function(v2) {
      var evalChildQuery = function(ref2) {
        return function(cqb) {
          return bind13(liftEffect8(read(ref2)))(function(v1) {
            return unChildQueryBox(function(v22) {
              var evalChild = function(v3) {
                return parallel3(bind13(liftEffect8(read(v3)))(function(dsx) {
      ...
      var go2 = function(ref2) {
        return function(v1) {
          if (v1 instanceof State) {
            return bind13(liftEffect8(read(ref2)))(function(v22) {
          ...
          if (v1 instanceof Subscribe) {
            return bind13(fresh(SubscriptionId)(ref2))(function(sid) {
              return bind13(liftEffect8(subscribe(v1.value0(sid))(function(act) {
          ...
          if (v1 instanceof Raise) {
            return bind13(liftEffect8(read(ref2)))(function(v22) {
              return bind13(liftEffect8(read(v22.handlerRef)))(function(handler3) {
          ...
          if (v1 instanceof Fork) {
            return bind13(fresh(ForkId)(ref2))(function(fid) {
              return bind13(liftEffect8(read(ref2)))(function(v22) {
                return bind13(liftEffect8($$new(false)))(function(doneRef) {
                  return bind13(fork3($$finally(liftEffect8(function __do4() {
          ...
          if (v1 instanceof Join) {
            return bind13(liftEffect8(read(ref2)))(function(v22) {
              return bind13(liftEffect8(read(v22.forks)))(function(forkMap) {
          ...
          if (v1 instanceof GetRef) {
            return bind13(liftEffect8(read(ref2)))(function(v22) {
              return pure17(v1.value1(lookup22(v1.value0)(v22.refs)));
            });
          }
          ;
    ...
    return function(i2) {
        ...
        return function(handler3) {
          return function(childrenInRef) {
            return function(childrenOutRef) {
              return unComponentSlot(function(slot5) {
                return function __do4() {
                  var childrenIn = map35(slot5.pop)(read(childrenInRef))();
                  var $$var2 = (function() {
                  ...
                  var isDuplicate = map35(function($69) {
                  ...
                  return bind11(read($$var2))(renderStateX2(function(v2) {
                    ...
                    ;
                    if (v2 instanceof Just) {
                      return pure18(renderSpec2.renderChild(v2.value0));
                    }
                    ;
      ...
      var render5 = function(lchs) {
        return function($$var2) {
          return function __do4() {
            var v2 = read($$var2)();
            var shouldProcessHandlers = map35(isNothing)(read(v2.pendingHandlers))();
      ...
      var evalDriver = function(disposed) {
        return function(ref2) {
          return function(q3) {
            return bind14(liftEffect9(read(disposed)))(function(v2) {
              if (v2) {
      ...
      return bind14(liftEffect9(newLifecycleHandlers))(function(lchs) {
        return bind14(liftEffect9($$new(false)))(function(disposed) {
          return handleLifecycle(lchs)(function __do4() {
            var sio = create();
...
var runUI2 = function(component5) {
  return function(i2) {
    return function(element4) {
      return bind15(liftEffect10(map37(toDocument)(bindFlipped10(document)(windowImpl))))(function(document2) {
...
var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind16(/* @__PURE__ */ runAppM(defaultEnv)(initialStore)(/* @__PURE__ */ component4(monadAffAppM)(monadCip30AppM)(monadStoreAppM)(monadAskAppM)(/* @__PURE__ */ interactionMonadDefault(monadAffAppM)(encodeJsonJString)(decodeJsonString)(/* @__PURE__ */ decodeFieldId(decodeJsonString))(monadCip30AppM))))(function(rootComponent) {
